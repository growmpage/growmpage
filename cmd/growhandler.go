...
func (g *Growmpage) handleGrowmpage() {
	...
	http.HandleFunc("/Update", func(w http.ResponseWriter, r *http.Request) {
		...
		case "rawUpdateGrowtable":
			g.growtable.RawUpdate(r.FormValue("json"), true)
...
func (g *Growmpage) handleInternal() {
	...
	http.HandleFunc("/ALERT", func(w http.ResponseWriter, r *http.Request) {
		...
		if message != ""{g.growganizer.Alerts = append(g.growganizer.Alerts, message)}
	...
	http.HandleFunc("/MEASURE", func(w http.ResponseWriter, r *http.Request) {
		...
		g.growtable.Add(climateObserving.Temperature, climateObserving.Humidity, 0, g.currentWeek()) //TODO: divide function: always meassure on picture!
	})
	http.HandleFunc("/PICTURE", func(w http.ResponseWriter, r *http.Request) {
		cameraObserving := g.growobserver.Picture()
		climateObserving := g.growobserver.Measure()
		g.growtable.Add(climateObserving.Temperature, climateObserving.Humidity, cameraObserving.Minutes, g.currentWeek())
